...
class TransferScreen extends StatefulWidget {
  ...
  const TransferScreen({this.fromPage = "", super.key});
...
class _TransferScreenState extends State<TransferScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<GeneralProvider>(context, listen: false).detectUserCountry();
    });
    _fetchAdminInfo();
    _fetchAdminWalletAddress();
    _fetchUserEthValue();
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            Navigator.push(context,
                              ...
                              final isNig = Provider.of<GeneralProvider>(context, listen: false).isNigerian;
                              return SelectNetworkScreen(
                                tonAddress: isNig ? adminWalletAddress : adminWalletAddress1,
                                ethNetwork: network,
                              );
                            }));
                          },
