...
class GeneralProvider extends ChangeNotifier {
  ...
  Future<void> detectUserCountry() async {
    try {
      userCountryCode = await LocationService.getUserCountryCode();
      notifyListeners();
    } catch (e) {
      print("Error in GeneralProvider location detection: $e");
    }
  }

  bool get isNigerian => userCountryCode == 'NG';
