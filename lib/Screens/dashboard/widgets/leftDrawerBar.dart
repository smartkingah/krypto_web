    ...
    return Column(
      children: [
        ...
        listItem(
          icon: 'home',
          title: "Dashboard",
          ontap: () => prov.setPage(data: 'dashBoardPage'),
        ),
        listItem(
          icon: 'history',
          title: "History",
          ontap: () => prov.setPage(data: 'history'),
        ),
        listItem(
          icon: 'kyc',
          title: "KYC Verification",
          ontap: () => prov.setPage(data: 'kyc'),
        ),
        listItem(
          icon: 'help',
          title: "Help and support",
          ontap: () => prov.setPage(data: 'support'),
        ),
        listItem(
          icon: 'settings',
          title: "Settings",
          ontap: () => prov.setPage(data: 'settings'),
        ),
        isAdmin
            ? listItem(
                icon: 'settings',
